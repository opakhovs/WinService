...
public class Controller {
    ...
    public void submitBtn(ActionEvent event) {
        ...
        handleSettingBtn(event);
    }

    private void setUpSettings() {
        if (CommandsGetter.getProperties() != null) {
    ...
    public void handleSettingBtn(ActionEvent event) {
        if (settingBtn.getText().compareTo("Settings") == 0) {
            settingBtn.relocate(294, 315);
            settingBtn.setText("Back");
            ...
            settingsLab.setVisible(true);
            setUpSettings();
        } else {
            settingBtn.setText("Settings");
            settingBtn.relocate(468, 43);
